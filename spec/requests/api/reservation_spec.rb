  ...
  path '/reservations/create' do
    post 'Create reservation' do
      ...
      parameter name: :reservation, in: :body, schema: {
        ...
        required: %w[user_id glamping_id check_in check_out total_price status]
      }

      response '201', 'reservation created' do
        let(:reservation) do
          { user_id: 1, glamping_id: 1, check_in: '2021-08-01', check_out: '2021-08-03', total_price: 100_000,
            status: 'booked' }
        end
        run_test!
      end
